...
window.renderStatistics = function (ctx, names, times) {
  ...
  var lengthCheck = names.length - times.length; // Ищем разницу в длинах массивов

  // Тут не использую тернарный оператор, т.к. в случае исп. будет захвачена ситуация с совпадающими длинами массивов
  // Хотя, наверное, можно?
  ...
  if (lengthCheck < 0) { // Имён оказалось меньше, чем значений времени
